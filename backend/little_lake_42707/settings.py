"""
Django settings for little_lake_42707 project.
...
ROOT_URLCONF = 'little_lake_42707.urls'
...
WSGI_APPLICATION = 'little_lake_42707.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "little_lake_42707 API",
    "DESCRIPTION": "API documentation for little_lake_42707 App",
    "VERSION": "v1",
}
